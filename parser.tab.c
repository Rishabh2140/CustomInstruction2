...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_RADIUS1 = 3,                    /* RADIUS1  */
  YYSYMBOL_RADIUS2 = 4,                    /* RADIUS2  */
  YYSYMBOL_HEIGHT = 5,                     /* HEIGHT  */
  YYSYMBOL_COMPUTE = 6,                    /* COMPUTE  */
  YYSYMBOL_VOLUME = 7,                     /* VOLUME  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "RADIUS1", "RADIUS2",
  "HEIGHT", "COMPUTE", "VOLUME", "$accept", "input", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: RADIUS1 RADIUS2 HEIGHT COMPUTE VOLUME  */
#line 33 "parser.y"
                                          {
        char *R = (yyvsp[-4].str), *r = (yyvsp[-3].str), *h = (yyvsp[-2].str);
